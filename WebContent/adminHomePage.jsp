    ...
    <div class="responsive-navigation visible-sm visible-xs">
        ...
        <div class="responsive_menu">
            <ul class="main_menu">
                 ...
                 <li><a href="country1.jsp" target="cu">Country</a></li>
			     <li><a href="stateInterface.jsp" target="cu">State</a></li>
			     <li><a href="cityInterface.jsp" target="cu">City</a></li>
			     <li><a href="#">Search</a>
			     	<ul>
					     <!-- <li><a href="adminUniversitySearch.jsp" target="cu">University Search</a></li>-->
					     <li><a href="adminCollegeSearch.jsp" target="cu">College Search</a></li>
					     <li><a href="adminStudentSearch.jsp" target="cu">Student Search</a></li>
					     <li><a href="studentAadharSearch.jsp" target="cu">Student Aadhar Search</a></li>
					     <li><a href="adminCourseSearch.jsp" target="cu">Course Search</a></li>
			     	</ul>
     			 </li>
     			 <li><a href="#">Registration</a>
			     	<ul>
					     <li><a href="universityInterface.jsp" target="cu">University Registration</a></li>
					     <li><%out.print("<a href=NoticePage.jsp?id="+alid+" target=cu>Notice Registration</a>"); %></li>
					</ul>
			     <li><%out.print("<a href=uniShowNotice.jsp?id="+alid+" target=cu>Show Notice</a>"); %></li>
            ...
            <div class="container">
                <nav class="main-navigation clearfix visible-md visible-lg" role="navigation">
                   <ul class="main-menu sf-menu">
                       <li><a href="adminHomePage.jsp">Home</a></li>
                       <li><a href="country.jsp" target="cu">Country</a></li>
			           <li><a href="stateInterface.jsp" target="cu">State</a></li>
			           <li><a href="cityInterface.jsp" target="cu">City</a></li>
			           <li><a href="#">Search</a>
			           		<ul>
        ...
        <div class="page-title clearfix">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h6><span class="page-active"><%out.print(alid); %></span></h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <iframe name="cu" src="country.jsp" width="100%" id="myFrame" scrolling="yes" frameborder="0" onload="sizeFrame('myFrame')" ></iframe></div>
                            </div>
                            ...
                            <div class="blog-comments-content">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="pull-left" href="#">
                                                <img class="media-object" src="onlinetest/images/blog/comment-author2.jpg" alt="">
                                            </div>
                                            <div class="media-body">
                                                <h4 class="media-heading">Justin Renfro</h4>
                                                <p>Temporibus, ea, praesentium eaque totam vel quos laboriosam quia recusandae doloribus sit dolore at consequatur beatae aliquam debitis porro quasi cupiditate quod!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
