...
<fieldset>
                  ...
                  <table border="1" cellpadding="10" style="background-color:#caf5ff;">
                      ...
                      <tr>
                          <td><input type="submit" value="Change" class="mainBtn" id="sign_user" onclick="ValidateNo();" name="submit"/></td>
                          <td> <input type="reset" value="Reset" class="mainBtn" id="sign_user" onclick="ValidateNo();" name="reset"/> </td>
                      </tr>
                  </table>
                  </fieldset>
              </form>
              ...
              if(request.getParameter("submit") != null)
              {
                  ...
                  else
                  {
                    ...
                    {
                        String q = DAO.addNewRecord("update studentreg set stupwd='"+npass+"' where stulid='"+stulid+"'");
