 ...
 <!-- This one in here is responsive menu for tablet and mobiles -->
    <div class="responsive-navigation visible-sm visible-xs">
        ...
        <div class="responsive_menu">
            <ul class="main_menu">
                <li><a href="collegeHomePage.jsp">Home</a></li>
                <li><%out.print("<a href=collegeUpdate.jsp?clglid="+clglid+" target=clg>Update</a>");%></li>
                <li><a href="#">Search</a>
                    <ul class="sub-menu">
                		<li><a href="collegeStudentSearch.jsp" target="clg">Student Search</a></li>
						<li><a href="studentAadharSearch.jsp" target="clg">Student Aadhar Search</a></li>
					</ul>
				</li>
				<li><a href="#">Registrations</a>
                    <ul class="sub-menu">
                		<li><a href="studentInterface.jsp" target="clg">Student Registration</a></li>
                		<li><%out.print("<a href=NoticePage.jsp?id="+clglid+" target=clg>Notice Registration</a>");%></li>
                	</ul>
                </li>
                <li><%out.print("<a href=uniShowNotice.jsp?id="+clglid+" target=clg>Show Notice</a>");%></li>
                <li><a href="collegeChangePass.jsp" target="clg">Change Password</a></li>
                <li><a href="collegeLogout.jsp"> Logout</a></li>
            </ul> <!-- /.main_menu -->
    ...
    <header class="site-header">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="logo">
                        <a href="collegeHomePage.jsp" title="Centralized University Portal" rel="home">
        ...
        <div class="page-title clearfix">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h6><span class="page-active"><%out.print(clglid); %></span></h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <iframe name="clg" src="studentInterface.jsp" width="100%" id="myFrame" scrolling="no" frameborder="0" onload="sizeFrame('myFrame')" ></iframe></div>
                            </div>
