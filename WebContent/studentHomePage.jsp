...
String stupwd = session.getValue("stupwd").toString();
    ...
    <div class="responsive-navigation visible-sm visible-xs">
        ...
        <div class="responsive_menu">
            <ul class="main_menu">
                ...
                <li><%out.print("<a href=collegeStudentDetail.jsp?stulid="+stulid+" target=stu>Update</a>");%></li>
                <li><a href="studentShowAllCourseStu.jsp" target="stu">Show Course Student</a></li>
			    <li><a href="studentShowAadharStu.jsp" target="stu">Show By Aadhar No</a></li>
			    <li><a href="studentShowNotice.jsp" target="stu">Show Notice</a></li>
                <li><a href="stuChangePass.jsp" target="stu">Change Password</a></li>
    ...
    <header class="site-header">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="logo">
                        <a href="studentHomePage.jsp" title="Centralized University Portal" rel="home">
        ...
        <div class="page-title clearfix">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h6><span class="page-active"><%out.print(stulid); %></span></h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <iframe name="stu" src="stuChangePass.jsp" width="100%" id="myFrame" scrolling="yes" frameborder="0" onload="sizeFrame('myFrame')" ></iframe></div>
                            </div>
