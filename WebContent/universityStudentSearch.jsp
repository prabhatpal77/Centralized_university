...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"><link href="bootstrap.min.css" rel="stylesheet" media="screen">
       ...
       <caption><h3>Search Student</h3></caption>
            <tr>
             <td><select name="ciid">
               ...
               <%
                 ResultSet rs = DAO.showAllRecord("select * from city");
          ...
          <tr>
             <td><input type="submit" name="search" Value="Search" class="mainBtn"/></td>
          </tr>
      </table>
    </form>
    <% 
     if(request.getParameter("search") != null)
     {
    	 ...
    	 <table>
    	    <%
    	    rs = DAO.showAllRecord("select * from city where ciid='"+clg.getCiid()+"'");
    	 ...
    	 <table border="1" cellpadding="10" style="background-color:#caf5ff;">
    	   <caption><h3>Student List</h3></caption>
    	    ...
    	    if(!clg.getCiid().equals("-select city-") && !stu.getStuname().equals(""))
    	       rs = DAO.showAllRecord("select * from studentreg where ciid='"+clg.getCiid()+"' and stuname like '%"+stu.getStuname()+"%' and status='active'");
    	    
    	    else if(!clg.getCiid().equals("-select city-") && stu.getStuname().equals(""))
     	       rs = DAO.showAllRecord("select * from studentreg where ciid='"+clg.getCiid()+"' and status='active'");
