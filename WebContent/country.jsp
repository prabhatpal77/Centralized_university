...
function validate(){
    if ((document.example2.cname.value=="")){
...
<center>
   <form action="countrySubmit.jsp" method="post"  name="example2" onsubmit="return validate()">
   <caption><h3>Country Insert</h3></caption>
       <table border="1" cellpadding="10" style="background-color:#caf5ff;">
         <tr>
            <td><b>Enter Name</b></td>
            <td><input type="text" name="cname" id="cname" onkeyup="AllowAlphabet()"/><font color="red">*</font></td>
         </tr>
         <tr>
           <td><b>Enter Flag</b></td>
           <td><input type="file" name="cflag" id="cflag"/></td>
         </tr>
         <tr>
            <td><b>Enter Description</b></td>
            <td><textarea name="cdesc" ></textarea></td>
         </tr>
         <tr>
           <td><input type="submit" class="mainBtn" id="sign_user" onclick="ValidateNo();" name="submit" value="Submit" onsubmit="return(validate());"/></td>
   ...
   <form>
   <caption><h3>Country Display</h3></caption>
      <table border="1" cellpadding="10" style="background-color:#caf5ff;">
          <tr>
             <th>Country ID</th>
             <th>Country Name</th>
          ...
          <tr>
             ...
             <%
                 out.println("<td><img src=adminimg/"+rs.getString(3)+" height=100 width=100></td>");
           %>
             <td><%out.print(rs.getString(4)); %></td>
             <%
         out.println("<td><a href=countryUpdate.jsp?cid="+rs.getString(1)+" class=\"mainBtns\">Update / Delete</a></td>");
    %>
     </tr>
          <%
          }while(rs.next());
